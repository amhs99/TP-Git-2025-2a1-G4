...
1. **Structure du projet Git**
   À la fin du projet, on avait trois branches principales : celle d’Amine, de Nadir et la mienne (Mustafa).
   On a fait des merges et des rebase pour rassembler tout le travail, puis j’ai créé une pull request qui a été fusionnée dans la branche principale (`main`) avec l’option “Squash & Merge”.
